...
def build_model(configs, device):
    """Build and initialize the Vanilla Quine model."""
    model = VanillaQuine(
...
def evaluate_model(model, data, index_list, device):
    """Evaluate the Vanilla Quine model."""
    print("Evaluating...")
    model.eval()
    with torch.no_grad():
...
if __name__ == "__main__":
    # Parse arguments
    import argparse
    parser = argparse.ArgumentParser(description="Run Vanilla Quine training")
